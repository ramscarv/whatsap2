...
export default function Room() {
    ...
    const dateNow = (date) => {
        ...
        // Formatando a hora e os minutos para o formato HH:mm
    ...
    return <>
        <div className="grid grid-cols-12 bg-dark-2">
            <div className="col-span-9 w-full">
                <div className="border-b border-zinc-500/5 flex items-center justify-between px-6 py-5 text-white">
                    <div className="flex items-center">
                        <div className="ml-3">
                            <p className="text-lg font-medium"> Sala {room?.name}</p>
                            <p className="text-xs font-medium italic text-gray-500">{members?.length} participantes</p>
                        </div>
                    </div>
                    <div className="flex items-center">
                        <button onClick={LeaveRoom} className="bg-zinc-500/10 hover:bg-zinc-100/10 rounded-full p-2 mr-2">
                ...
                <div className="border-t border-zinc-500/5 px-6 py-5 fixed bottom-0 w-full max-w-[62.3%]">
                    <form onSubmit={e => {
                        ...
                        <div className="flex items-center">
                            <input name="message" type="text" className="bg-zinc-500/10 hover:bg-zinc-100/10 rounded-md w-full px-4 py-2 text-white outline-none" autoComplete="off" placeholder="Escreva algo..." />
                            <button type="submit" className="bg-zinc-500/10 hover:bg-zinc-100/10 rounded-md p-2 ml-2 transition-all duration-200">
            ...
            <div className="col-span-3 border-l border-zinc-500/5 h-screen w-full">
                <div className="overflow-y-auto h-full p-3 space-y-2">
                    {members?.map(member => (
                        <div className="flex items-center justify-between px-6 py-5 text-white bg-zinc-500/10 rounded-lg">
                                ...
                                <div className="ml-3 flex items-center justify-between gap-2 w-full">
                                    ...
                                    {room?.owner?.username === member?.username && <>
                                        <div className="flex items-center justify-center gap-1">
                                            <p className="text-sm font-medium uppercase font-semibold opacity-50">Criador</p>
                                        </div>
                                    </>}
